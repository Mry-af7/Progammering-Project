      ...
      <div class="grid md:grid-cols-4 gap-8">
        ...
        <div>
          ...
          <ul class="space-y-2 text-orange-100 text-sm">
            <li><a href="/register?type=student" class="hover:text-white transition-colors">Maak je profiel</a></li>
            <li><a href="/info" class="hover:text-white transition-colors">Career Launch Info</a></li>
            <li><a href="/bedrijven" class="hover:text-white transition-colors">Ontdek bedrijven</a></li>
          </ul>
        </div>
        ...
        <div>
          ...
          <ul class="space-y-2 text-orange-100 text-sm">
            <li><a href="/wiezijnwe" class="hover:text-white transition-colors">Wie zijn we?</a></li>
