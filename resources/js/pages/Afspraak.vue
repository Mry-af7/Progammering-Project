    ...
    <div v-if="selectedCompany" class="bg-gradient-to-r from-orange-50 to-red-50 border border-orange-200 p-6 mb-8 rounded-2xl">
        <div class="flex items-center">
            ...
            <div>
                ...
                <p class="text-gray-600">15 maart 2025 • Campus Brussel</p>
    ...
    <div class="grid md:grid-cols-4 gap-12">
        ...
        <div>
            ...
            <ul class="space-y-3 text-orange-100">
                <li><a href="/register?type=student" class="hover:text-white transition-colors flex items-center">
                    <span class="mr-2">→</span>Maak je profiel</a></li>
                <li><a href="/afspraak" class="hover:text-white transition-colors flex items-center">
                    <span class="mr-2">→</span>Speeddate events</a></li>
            </ul>
        </div>
        ...
        <div>
            ...
            <ul class="space-y-3 text-orange-100">
                <li><a href="/bedrijven" class="hover:text-white transition-colors flex items-center">
                    <span class="mr-2">→</span>Browse talenten</a></li>
            </ul>
        </div>
