...
<template>
    <div class="min-h-screen bg-orange-50">
            ...
            <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                ...
                <div v-show="mobileMenuOpen" class="md:hidden mt-4 pb-4 border-t border-orange-200">
                    <div class="flex flex-col space-y-2 pt-4">
                        <Link v-for="item in navItems" :key="item.href" :href="item.href"
                            class="px-4 py-2 text-gray-700 hover:text-orange-600 font-medium">
                        {{ item.label }}
                        </Link>
        ...
        <main class="max-w-2xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
            <!-- Status Message -->
            <div v-if="status"
                class="mb-6 p-4 bg-green-50 border border-green-200 rounded-xl text-green-700 text-center">
                {{ status }}
            </div>
                ...
                <div class="p-8">
                    ...
                    <div class="flex justify-center mb-8">
                        <div class="bg-gray-100 p-1 rounded-xl flex">
                            ...
                            ]" @click="activeTab = 'bedrijf'" type="button">
                            ...
                            <button :class="[
                                ...
                                activeTab === 'student'
                                    ? 'bg-orange-500 text-white shadow-lg'
                                    : 'text-gray-600 hover:text-orange-600'
                            ]" @click="activeTab = 'student'" type="button">
                                <svg class="w-5 h-5 inline-block mr-2" fill="none" stroke="currentColor"
                                    viewBox="0 0 24 24">
                                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                    ...
                    <form @submit.prevent="submit" class="space-y-6">
                        ...
                        <div>
                            <div class="flex items-center justify-between mb-2">
                                ...
                                <Link v-if="canResetPassword" href="/forgot-password"
                                    class="text-sm text-orange-600 hover:text-orange-700 font-medium" :tabindex="5">
                                Forgot password?
                                </Link>
                            </div>
                            <Input id="password" type="password"
                                class="w-full px-4 py-3 border border-gray-300 rounded-xl focus:outline-none focus:ring-2 focus:ring-orange-500 focus:border-transparent transition-all"
                                required :tabindex="2" autocomplete="current-password" v-model="form.password"
                        ...
                        <div class="text-center pt-4 border-t border-gray-100">
                            ...
                            <Link :href="activeTab === 'bedrijf' ? '/register/bedrijf' : '/register'" :tabindex="5"
            ...
            <div class="grid md:grid-cols-2 gap-6 mt-8">
                <div class="bg-white rounded-2xl p-6 shadow-sm">
                    ...
                    <p class="text-sm text-gray-600">Vind je droomstage of eerste job. Bouw je profiel en laat bedrijven
                        jou vinden.</p>
                </div>
                ...
                <div class="bg-white rounded-2xl p-6 shadow-sm">
                    ...
                    <p class="text-sm text-gray-600">Ontdek getalenteerde Erasmus studenten voor stages, studentjobs en
                        vaste posities.</p>
                </div>
            </div>
        </main>
                ...
                <div class="grid md:grid-cols-4 gap-8">
                    ...
                    <div>
                        ...
                        <ul class="space-y-2 text-orange-100 text-sm">
                            ...
                            <li>
                                <Link href="/info" class="hover:text-white transition-colors">Career Launch Info</Link>
                            </li>
                            <li>
                                <Link href="/bedrijven" class="hover:text-white transition-colors">Ontdek bedrijven
                                </Link>
                            </li>
                        </ul>
                    </div>
                    ...
                    <div>
                        ...
                        <ul class="space-y-2 text-orange-100 text-sm">
                            <li><a href="mailto:gdt.kaai.student@ehb.be"
                                    class="hover:text-white transition-colors">gdt.kaai.student@ehb.be</a></li>
                            <li><a href="tel:+3225233737" class="hover:text-white transition-colors">02 523 37 37</a>
                            </li>
