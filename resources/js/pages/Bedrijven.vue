...
<template>
  <div class="min-h-screen bg-gradient-to-br from-orange-50 via-white to-orange-50">
    <!-- Navigation -->
    <MainNavigation activePage="bedrijven" :favoritenCount="favorieten.length" />
              ...
              <div class="space-y-6">
                <div>
                  ...
                  <div class="space-y-3">
                    ...
                    <div class="flex items-center">
                      <svg class="w-5 h-5 text-gray-400 mr-3" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M8 7V3a1 1 0 011-1h6a1 1 0 011 1v4h3a2 2 0 012 2v9a2 2 0 01-2 2H5a2 2 0 00-2-2V9a2 2 0 012-2h3z" />
                      </svg>
