...
const bedrijven = ref([
  { name: 'Accenture', src: '/images/logos/accenture-logo.svg', favoriet: false },
  ...
  // werkt nie idk wrm { name: 'Safran', src: '/images/logos/safran-logo.svg', favoriet: false },
  ...
  <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
    <div class="flex justify-between items-center h-16">
      ...
      <div class="hidden md:flex items-center space-x-1">
        ...
        <Link href="/alle-bedrijven" class="px-4 py-2 text-orange-600 bg-orange-100 rounded-lg font-medium transition-colors">Bedrijven</Link>
